import 'package:vania/foundation.dart' show DatabaseException, Logger;

import '../contract/database_connection.dart';
import '../monitoring/database_monitor.dart';

/// Wraps a driver-provided [DatabaseConnection] and records timing +
/// alerts through the shared [DatabaseMonitor].
